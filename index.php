...
<body>
	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<marquee behavior="scroll" id="marq"  scrollamount=6 direction="up" height="314px" onmouseover="nestop()" onmouseout="nestrt()">
				<div>
				<b>💥<u> NOTICES AND ANNOUNCEMENTS </u>💥</b></br></br>
				<p><b>• Launch of a new high-speed train service between Mumbai and Ahmedabad, which is expected to reduce travel time by several hours.</b></p></br>
				<p><b>• The Indian Railways has partnered with a major technology company to introduce a new mobile app that allows passengers to book tickets and track trains in real-time.</b></p></br>
